...
const Modal = ({ modalId, setShowModal, handleClickDetail }) => {
  ...
  const [dialogHeight, setDialogHeight] = useState(
    window.innerHeight < 480 ? window.innerHeight - 180 + 'px' : '24rem'
  );
  ...
  return (
    <>
      {isLoading ? (
        ...
        <Dialog open={open} size={'lg'} handler={handleClickDetail}>
          ...
          <DialogBody className='dialog-body' style={{ height: dialogHeight }}>
            <div className='movie-detail'>
              ...
              <div className='w-full mt-4 mx-auto'>
                <div>
                  <Typography className='font-semibold text-black-500'>Plot :</Typography>
